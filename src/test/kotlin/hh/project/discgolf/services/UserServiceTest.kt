...
class UserServiceTest
    ...
    fun `Every value is 0`() {
        ...
        val valueFromFunction = userService.formatTotalTimePlayed(0L)
    ...
    fun `Over zero hours but under ten hours - other values are zeros`() {
        ...
        val valueFromFunction = userService.formatTotalTimePlayed(7_200L)
        assertThat(valueFromFunction).isEqualTo(correctValue)
    }
    ...
    fun `Over ten hours - other values are zeros`() {
        ...
        val valueFromFunction = userService.formatTotalTimePlayed(46_800L)
        assertThat(valueFromFunction).isEqualTo(correctValue)
    }
    ...
    fun `Over zero minutes but under ten minutes - other values are zeros`() {
        ...
        val valueFromFunction = userService.formatTotalTimePlayed(480L)
        assertThat(valueFromFunction).isEqualTo(correctValue)
    }
    ...
    fun `Over ten minutes - other values are zeros`() {
        ...
        val valueFromFunction = userService.formatTotalTimePlayed(660L)
        assertThat(valueFromFunction).isEqualTo(correctValue)
    }
    ...
    fun `Over zero seconds but under ten seconds - other values are zeros`() {
        ...
        val valueFromFunction = userService.formatTotalTimePlayed(1L)
        assertThat(valueFromFunction).isEqualTo(correctValue)
    }
    ...
    fun `Over ten seconds - other values are zeros`() {
        ...
        val valueFromFunction = userService.formatTotalTimePlayed(11L)
        assertThat(valueFromFunction).isEqualTo(correctValue)
    }
